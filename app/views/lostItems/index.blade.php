    ...
    @foreach ($lostItems as $lostItem)
    	<div class="col-md-3 work text-center">
    	    @if (!is_null($lostItem->image_path))
    	    	<a href="{{{ action('LostItemsController@show', $lostItem->id) }}}"><img src="{{ $lostItem->image_path }}" alt="" style="width:150px;height:150px; margin-top:15px;"></a>
    	    @else
    	    	<a href="{{{ action('LostItemsController@show', $lostItem->id) }}}"><img src="/img/default.png" alt="" style="width:150px;height:150px; margin-top:15px;">
    	    @endif
